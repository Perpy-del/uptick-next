...
import { BlogInterface } from '@/context/UptickContext';
...
const Blog = () => {
  ...
  const filteredBlogs = activeCategory === null
  ? blogs
  ...
  return (
    <div className="bg-slate-50 text-black dark:bg-[#212529] dark:text-white font-sans">
      ...
      <div className="px-5 md:px-10 lg:px-20">
        ...
        <div>
          {filteredBlogs.map((blog: BlogInterface, index: number) => {
            return (
              <div
                key={index}
